...
/**
 * ANIMATED ROLE TITLES — edit freely
 */
const ROLE_TITLES = [
...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      tl.from(".hero-glow-bg", {
        ...
        .from(".hero-eyebrow", { y: 20, opacity: 0, duration: 0.7 }, "-=1.0")
        .from(
          ".hero-title-line",
          { y: 35, opacity: 0, duration: 0.9, stagger: 0.12 },
          "-=0.5"
        )
        .from(".hero-role-block", { y: 25, opacity: 0, duration: 0.8 }, "-=0.6")
        ...
        .from(
          ".hero-visual-card",
          { y: 40, opacity: 0, scale: 0.95, duration: 1.1, ease: "power2.out" },
          "-=0.8"
        )
        .from(
          ".floating-badge",
        ...
        .from(".hero-scroll-indicator", { opacity: 0, y: -15, duration: 0.8 }, "-=0.2");
    }, heroRef);
  ...
  return (
    <section id="home" className="hero" ref={heroRef}>
      ...
      <div className="hero-container">
        <div className="hero-text-col">
          <div className="hero-eyebrow">
            ...
            <span className="hero-eyebrow-text">HII, I'M </span>
          </div>
          ...
          <p className="hero-description">
            I turn ideas into fast, polished web apps — clean React
            front-ends, solid Node/Express APIs, and UI that doesn't feel
            like a template.
          </p>

          <div className="hero-buttons">
            <a href="#projects" className="btn btn-primary hero-cta-btn" id="hero-cta-work">
              <span>VIEW MY WORK</span>
              <span className="btn-arrow" aria-hidden="true">→</span>
            </a>

            <a href="#contact" className="btn btn-secondary hero-cta-btn" id="hero-cta-connect">
        ...
        <div className="hero-visual-col">
          <div className="hero-visual-wrapper">
            ...
            <div className="floating-badge badge-code-tags" title="Code Tags" aria-hidden="true">
              <Code2 size={16} />
              <span>&lt;/&gt;</span>
            </div>

            <div className="floating-badge badge-brackets" title="Object Notation" aria-hidden="true">
              <span>&#123; &#125;</span>
            </div>
      
            <div className="floating-badge badge-react" title="React Stack" aria-hidden="true">
      ...
      <a href="#about" className="hero-scroll-indicator" aria-label="Scroll to explore more sections">
